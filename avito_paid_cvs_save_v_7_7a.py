...
def build_stoplist_from_output() -> pd.DataFrame:
...
def main():
    ...
    with sync_playwright() as p:
        ...
        # ───── СТОП-ЛИСТ ─────
        stop_df = build_stoplist_from_output()
        ...
        desired_order = [
            "purchased_at_web",
            "updated_at_web", "candidate_name_web", "phone_api", "email_api",
            "desired_title_api", "city_web", "avito_id", "respond_status",
            "json_open", "json_paid", "link", "chat_id_api", "resume_id", "api_difference"
        ]
